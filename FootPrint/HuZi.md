...
5. 不要试图赚最大的利润，特别是对三这种上下皆可的case。这样很容易判断失误的时候亏一笔大的
...
* 课程设罝
  1. 交易是长跑，既要弯道超车，还得笑到最后
  2. 流水师兄补全了图表框架的方法论，553补全了对行情的理解
  3. 心态决定了能不能赚钱，运气决定能不能大赚
  4. 梭哈是一种智慧。甄别出机会，一定要梭哈。单笔赚大，才是交易的魅力

* 图表的认识
  1. 图表的意义是告诉你某个位置可能有机会，是一个市场切入点，可能有，实际有没有谁也不知道，降低预期，抱朴守拙
  2. 不是预测，而是跟随
  3. 技术，心态，运气
...
* 交易方法论
  ...
  1. 自我认知决定看待交易的角度，即交易理念
     1. 自由心证交易：做看得懂的行情；看懂市场的方向，然后跟随
     2. 策略性交易：用历史数据回测策略，筛出高胜率策略，应用于未来交易；利用历史预测未来；通过重复策略进行永赚
  2.  交易理念物化成交易系统
     1. 试仓：进场策略、止损策略
     2. 加仓：进场策略、止损策略
     3. 止盈策略
...
* 级别的划分
  ...
  5. 级别的意义：通过该级别的复盘，可以确定在一个确定的时间长度、时间跨度下，可能出现的次数
     ...
     2. 耐心等大机会，小机会消耗精力多了，大机会来临必将缺乏精力、定力拿不住单子。咬定青山不放松，需要体力精力支撑

  6. 做单级别：H4、H1、F30

     1. 多次小级别止损汇成一次大级别止损，一个大级别单子的回报要远高于多次小级别单子
     2. 勤止盈，小步抬高 ，积累本金，等待大机会，把所有浮盈当炮灰，一把梭哈
     3. 频繁做单大概率是Fomo了，要熔断
